...
def retrieve_html():
    for year in range(2013,2019):
        for month in range(1,13):
            ...
            if not os.path.exists("MyData/Html_Data/{}".format(year)):
                os.makedirs("MyData/Html_Data/{}".format(year))
            with open("MyData/Html_Data/{}/{}.html".format(year,month),"wb") as output:
